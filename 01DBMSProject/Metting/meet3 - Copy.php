...
if ($result->num_rows > 0) {
  while ($row = $result->fetch_assoc()) {
    ...
    $message ="सभेचे शीर्षक $meetingtitle दिनांक : $meetingDate येथे $meetingTime मध्ये $place सभेचे अजेंडा आहे $agenda";
}
}
...
?>
<div id="scrolling-container" style=" top: 0; left: 0; width: 100%; background-color: white; padding: 5px; box-sizing: border-box;">
