...
<button onclick="window.location.href='marriage.php'">Marriage Certificate</button>
<button onclick="window.location.href='Recidence.php'">Residence Certificate</button>
