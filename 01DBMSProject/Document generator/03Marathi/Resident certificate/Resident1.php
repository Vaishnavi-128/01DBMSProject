...
<html>
  ...
  <body>
    <h1>रहिवासी दाखला</h1>
    <form action="Residentback.php" method="post">
      <label for="office">ग्रामपंचायत ऑफिस : </label>
      ...
      <label for="Adhar">आधार कार्ड नंबर : </label>
      <input type="text" id="Adhar" name="Adhar" required><br><br>
      <label for="village">हद्दीतील मौजे : </label>
