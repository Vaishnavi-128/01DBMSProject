...
<html>
  ...
  <body>
    <h1>मृत्यू दाखला</h1>
    <form action="DaethMarathi1.php" method="post">
      <label for="name">मृत व्यक्तीचे नाव : </label>
      ...
      <label for="date">मृत्यूची तारीख : </label>
      <input type="date" id="date" name="date" required><br><br>
      <label for="gender">लिंग : </label>
      <input type="text" id="gender" name="gender" required><br><br>
       <label for="placeb">मृत्यूचे ठिकाण : </label>
      ...
      <label for="cause">मृत्यूचे कारण : </label>
      ...
      <label for="address1">मृत्यूच्या वेळी मृत व्यक्तीचा पत्ता: </label>
      <input type="text" id="address1" name="address1" required><br><br>
      <label for="address2">मृत व्यक्तीचा कायमचा पत्ता : </label>
