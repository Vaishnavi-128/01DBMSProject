...
<body>
	...
	<img src="scanner.jpg" alt="My Image">
  <button type="button" class="btn btn-light btn-lg" value="Go back!" onclick="history.back()">Back</button>
	<button type="button" class="btn btn-outline-light" onclick="window.location.href = 'Doner.php';">Generate a Receipt</button>
</body>
</html>