...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $sql = "SELECT email FROM deathcertificate WHERE id = $id"; // Modify this query according to your table structure
    ...
    if ($result->num_rows > 0) {
        ...
        $message = "Dear User,\n\nYour certificate is now ready. Please collect it from GramPanchayat.\n\nRegards,\nAdmin";
