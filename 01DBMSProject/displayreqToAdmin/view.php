...
<body>
    <div class="container">
        ...
        if(isset($_GET['id'])) {
            ...
            // Fetch details of birth certificate with the given ID
            $sql = "SELECT * FROM birthcertificate WHERE id=$id";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
                $row = $result->fetch_assoc();
                // Display all details here
                echo "<h2>Birth Certificate Details</h2>";
                echo "<p><span class='label'>Name of Child:</span> " . $row["nameOfChild"] . "</p>";
                ...
                echo "<p><span class='label'>Date of Birth:</span> " . $row["DOB"] . "</p>";
                echo "<p><span class='label'>Gender:</span> " . $row["gender"] . "</p>";
                echo "<p><span class='label'>Place of Birth:</span> " . $row["placeOfBirth"] . "</p>";
                ...
                echo "<p><span class='label'>Address of Parent:</span> " . $row["AddressOfParent"] . "</p>";
                echo "<p><span class='label'>Permanent Address:</span> " . $row["PermenentAddress"] . "</p>";
                ...
                echo "<a href='birthcertificate.php?id=" . $row["id"] . "' class='btn btn-primary'>Create Document</a>";
            } else {
